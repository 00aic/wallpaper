...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const searchData = async () => {
      try {
        const res = await api_api.apiSearchData(queryParams.value);
      ...
      return common_vendor.e({
        ...
        j: common_vendor.f(historySearch.value, (tab, k0, i0) => {
          return {
            ...
            b: common_vendor.o(($event) => clickTab(tab), tab),
            c: tab
          };
        })
      } : {}, {
        k: recommendList.value.length
      }, recommendList.value.length ? {
        l: common_vendor.p({
          type: "trash",
          size: "25"
        }),
        m: common_vendor.o(removeHistory),
        n: common_vendor.f(recommendList.value, (tab, k0, i0) => {
          return {
            a: common_vendor.t(tab),
            b: common_vendor.o(($event) => clickTab(tab), tab),
            c: tab
        ...
        q: common_vendor.f(classList.value, (item, k0, i0) => {
          return {
            a: item.smallPicurl,
        ...
        r: classList.value.length || noData.value
